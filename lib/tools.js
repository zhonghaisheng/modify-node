...
module.exports = {
    ...
    delNode:function(delCon,html){
        ...
        var delConPos1 = delCon.indexOf(">");
        var delConPos2 = delCon.lastIndexOf("<");
        var delConPos3 = delCon.lastIndexOf("/");
        var delConBefore = delCon.substring(0, delConPos1+1);
        var delConBefore2 = delCon.substring(0, delConPos1);
        var delConAfter = delCon.substring(delConPos2);
        var delConAfter2 = delCon.substring(delConPos3+1);
        var delConText = delConBefore + "(.*)<\/" +delConAfter2;
        console.log(delConText);
        html = html.replaceAll(delConText," "); 
        return html;  
    },
